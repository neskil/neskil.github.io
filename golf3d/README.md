...
sheet per course — eighty-four holes in fourteen pictures. The angles are not
...
```sh
node golf3d/tools/turntable.mjs                        # all fourteen, ~5 minutes
...
`tests.html` holds all eighty-four holes to **zero errors**, so a new hole
...
**What the first pass found**, over the fourteen courses:
