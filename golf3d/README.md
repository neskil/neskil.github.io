...
inlay comes out as a ring of sand round a disc of fairway. Until the terrain
mesh can be punched to a circle, an inlay is flush or it is wrong. Whinstone's
...
Open `tests.html`. 973 assertions covering the surfaces, the collision
