...
(function (G3) {
    ...
    /* ── shuffle: the course picked for you ──────────────────────────────
       ...
       The list is fourteen courses long and most players walk it in the order
       ...
       of the fourteen wants one of the other three. */
    G3.SHUFFLE_MODES = [
        {
    ...
    /* What a mode would actually draw from, and whether it had to give ground
       ...
       **A mode never comes back empty.** "New to you" stops meaning anything
       the moment you have played all fourteen, and "beat a best" means nothing
