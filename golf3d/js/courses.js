    ...
    function scoop(pads, spec) {
        ...
        for (i = 0; i < pads.length; i++) {
            ...
            /* An inlaid bunker keeps its flat floor, and this is the one place
               ...
               as well. Sink the sand and what appears in the hollow is the
               grass that was always there, so a dished inlay comes out as a
               ring of sand round a disc of fairway. Until the terrain mesh can
               be punched to a circle, an inlay is flush or it is wrong. What
