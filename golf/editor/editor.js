...
(function (GOLF) {
    ...
    var EXPORT_ORDER = ['walls', 'water', 'sand', 'ice', 'bumpers', 'slopes'];
    function kindOf(key) {
    ...
    var DEFAULT_RECT = { walls: [26, 160], water: [200, 140], sand: [180, 160], ice: [220, 180], slopes: [260, 220] };
    ...
    function blankHole() {
        return {
            ...
            tee: { x: 140, y: 320 },
            hole: { x: 820, y: 320 },
            walls: [], water: [], sand: [], ice: [], bumpers: [], slopes: []
        };
    }
    ...
    function runChecks(h) {
        ...
        var rects = [];
        ['walls', 'water', 'sand', 'ice', 'slopes'].forEach(function (k) {
    ...
    $('btn-copy-ai').addEventListener('click', function () {
        var prompt = 'I am building a hole for Pocket Links, an eighteen-hole 2D mini golf game. ' +
            ...
            '- `sand` — heavy friction. `ice` — about three times the roll of grass.\n' +
    ...
    var TOOL_KEYS = { '1': 'walls', '2': 'water', '3': 'sand', '4': 'ice', '5': 'bumpers', '6': 'slopes', '7': 'tee', '8': 'hole' };
