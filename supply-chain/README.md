...
- Visuals: the isometric 2.5D view keeps getting depth passes (scenery,
  themed supplier sites, night atmosphere — moon/lit windows/beacon/
  fireflies/vignette). Possible next steps: a slow day↔night cycle
  (currently fixed at night), animated water reflections beyond the
  moonlight shimmer, drifting clouds casting soft ground shadows.
