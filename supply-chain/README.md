...
- Visuals: the isometric 2.5D view keeps getting depth passes (scenery,
  themed supplier sites, night atmosphere, a cosmetic day↔night cycle
  and rotating weather — clouds/rain/snow with wind). Possible next
  steps: weather that actually affects play (rain slowing trucks, etc.),
  richer water reflections, seasonal palettes, or lightning flashes
  during storms.
