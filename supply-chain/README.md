...
- Visuals: the isometric 2.5D view keeps getting depth passes. Landed:
  ...
  **Graphics roadmap (next ideas, unbuilt):**
  - Emissive bloom on lit windows / beacons / headlights (additive glow sprite).
