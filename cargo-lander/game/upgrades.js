...
const upgradeCatalog = [
    ...
    { id: 'magneticDeck',       name: 'Magnetic Deck',         desc: 'Increases magnetic pull strength on nearby cargo by 20% per level.',                   maxLevel: 4, basePrice: 1500, category: 'Utility',    icon: '🧲' },
